...
namespace ns3
{
    ...
    main(int argc, char *argv[])
    {
        ...
        ndn::L3RateTracer::InstallAll("dsccp4-1-pcon-1000_throughput.txt", Seconds(0.5));
        ndn::AppDelayTracer::InstallAll("dsccp4-1-pcon-1000_delay.txt");
        L2RateTracer::InstallAll("dsccp4-1-pcon-1000_drop.txt", Seconds(0.5));
        Simulator::Run();
        Simulator::Destroy();
