...
namespace ns3
{
    ...
    main(int argc, char *argv[])
    {
        ...
        ndn::L3RateTracer::InstallAll("dsccp4-2-pcon-2000_throughput.txt", Seconds(0.5));
        ndn::AppDelayTracer::InstallAll("dsccp4-2-pcon-2000_delay.txt");
        L2RateTracer::InstallAll("dsccp4-2-pcon-2000_drop.txt", Seconds(0.5));
        Simulator::Run();
        Simulator::Destroy();
