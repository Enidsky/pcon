...
namespace ns3
{
    ...
    main(int argc, char *argv[])
    {
        ...
        // consumerHelper.SetAttribute("Tos", UintegerValue(5));
        consumerHelper.SetAttribute("DelayStart", UintegerValue(80000));  // 延迟10秒启动
        consumerHelper.Install("C2");

        // C3
        consumerHelper.SetPrefix("/C");
        // consumerHelper.SetAttribute("Tos", UintegerValue(5));
        consumerHelper.SetAttribute("DelayStart", UintegerValue(160000));  // 延迟20秒启动
        ...
        ndn::L3RateTracer::InstallAll("dsccp3-2-throughput-320.txt", Seconds(0.5));
        ndn::AppDelayTracer::InstallAll("dsccp3-2-delay-320.txt");
        L2RateTracer::InstallAll("dsccp3-2-drop-320.txt", Seconds(0.5));
        Simulator::Run();
        Simulator::Destroy();
