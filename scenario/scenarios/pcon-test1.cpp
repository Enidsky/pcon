...
namespace ns3
{
    ...
    main(int argc, char *argv[])
    {
        ...
        topologyReader.SetFileName("topologies/pcon-1.txt");
        topologyReader.Read();
        ...
        ndn::L3RateTracer::InstallAll("pcon-test-1-throughput.txt", Seconds(1));
        ndn::AppDelayTracer::InstallAll("pcon-test-1-delay.txt");
        L2RateTracer::InstallAll("pcon-test-1-drop.txt", Seconds(1));
        Simulator::Run();
        Simulator::Destroy();
